class FIFOQueue:
    ...
    def contains(self, item):
        ...
        :return: True, jeśli element jest w kolejce; False w przeciwnym razie.
        """
    ...
    def to_list(self):
        """
        Zwraca kolejkę jako listę.

        :return: Lista zawierająca elementy kolejki.
        """
